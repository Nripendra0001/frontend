...
window.checkAns = function(btn, isCorrect){
  let attempted = document.querySelectorAll(".q-box button.correct, .q-box button.wrong").length;
document.getElementById("mockDone").innerText = attempted;
document.getElementById("mockProgressFill").style.width = (attempted/100*100)+"%";
...
window.finishTest = function(){
  ...
  alert(
    ...
    "\n❌ Wrong: " + (totalAttempt - correctCount)
  );
